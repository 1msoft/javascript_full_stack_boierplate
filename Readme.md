# 概述
本项目为javascript全栈开发建立一个可行的解决方案. 正在进行中
...
目前采用nodejs 6.0 LTS 基于 V8 5.0，支持es6的全部语法特性。但是前端代码需要通过babel转换为es5的语法，以保持更多的兼容性。
...
基于以上的流程，我们设定了对应的工具链
+ 编辑器/IDE：VSCode or Sublime Text
+ 开发工具: Chrome DevTools, Redux DevTools, VSCode debug
+ 工作管理：Gulp
+ 打包：Webpack
